...
/**
 * 求文本的单词数,测试文本:
 *      hadoop,java,hadoop,spark,hbase,hbase
 *      java,sqoop,flume,spark
 *      python,flume,spark,hadoop,hadoop
 * 结果:
 *
 *      flume	2
 *      hadoop	4
...
public class WordCount extends Configured implements Tool {
     ...
     * Mapper
     */
    public static class WoldCountMapper extends Mapper<LongWritable, Text, Text, IntWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            System.out.print("map keyIn: " + key + " ValueIN: " + value);
    ...
    public static void main(String[] args){
        Configuration configuration = new Configuration();
        args = new String[]{
            "hdfs://loc-header:9000//data/input/wordcout_data.csv",
